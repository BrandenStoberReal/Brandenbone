...
public:
    ...
    BRANDENBONE_API static std::wstring UTF8ToWstring( const std::string& str );
    ...
    /// <param name="str">UTF-8 string</param>
    /// <returns>wide char string</returns>
    BRANDENBONE_API static std::string WstringToUTF8( const std::wstring& str );
    ...
    /// <returns>wide char string</returns>
    BRANDENBONE_API static std::wstring AnsiToWstring( const std::string& input, DWORD locale = CP_ACP );
    ...
    BRANDENBONE_API static std::string WstringToAnsi( const std::wstring& input, DWORD locale = CP_ACP );
    ...
    BRANDENBONE_API static std::wstring FormatString( const wchar_t* fmt, ... );
    ...
    BRANDENBONE_API static std::wstring StripPath( const std::wstring& path );
    ...
    BRANDENBONE_API static std::wstring GetParent( const std::wstring& path );

    /// <summary>
    /// Get current process exe file directory
    /// </summary>
    /// <returns>Exe directory</returns>
    BRANDENBONE_API static std::wstring GetExeDirectory();
    ...
    BRANDENBONE_API static std::wstring ToLower( std::wstring str );
    ...
    BRANDENBONE_API static std::wstring RandomANString( int length = 0 );
    ...
    BRANDENBONE_API static std::wstring GetErrorDescription( NTSTATUS code );
    ...
    BRANDENBONE_API static bool FileExists( const std::wstring& path );
};
...
{
public:
    BRANDENBONE_API CriticalSection()
    {
    ...
    BRANDENBONE_API void lock()
    {
        EnterCriticalSection( &_native );
    }

    BRANDENBONE_API void unlock()
    {
...
{
public:
    BRANDENBONE_API CSLock( CriticalSection& cs )
        : _cs( cs ) 
    {
        cs.lock();
    }

    BRANDENBONE_API ~CSLock()
    {
        _cs.unlock();
    }
